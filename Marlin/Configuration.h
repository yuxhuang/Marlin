...
/**
 * JGAurora A3S 3D Printer Firmware - Based on Marlin, modified from A5 firmware by Sam
 * A5 firmware authors: Telli Mantelli, Kris Waclawski, Michael Gilardi & Samuel Pinches
 *
 * This fork of Marlin was created by the community for the 
 * JGAurora A3S 3D printer. Big thanks to the Marlin developers
 * for constant updates! We hope this opens up the possibilities
 * for the A3S community by providing a purely open source firmware.
 * Enjoy! :)
 *
 */
...
#define STRING_CONFIG_H_AUTHOR "(Telli Mantelli, Kris Waclawski, Samuel Pinches & Michael Gilardi, 22 Jan 2018)" // Who made the changes.
#define SHOW_BOOTSCREEN
#define STRING_SPLASH_LINE1 "Marlin 1.1.8C for A3S" // will be shown during bootup in line 1
 ...
 *    15 : 100k thermistor calibration for JGAurora A3S hotend
 ...
 */
#define TEMP_SENSOR_0 5 // manual calibration of thermistor in JGAurora A3S hotend
...
#define PID_K1 0.95      // Smoothing factor within the PID
  ...
  // JGAurora A3S (tuned at 210C on an A5)
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // JGAurora A3S (tuned at 70C on an A5... ideally someone else will retune this and enable PID)  
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 800, 85.26 } // Updated to use the bulldog extruder
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define GRID_MAX_POINTS_X 4    // As suggested by DaHai, https://www.youtube.com/watch?v=CBlADPgQqL0
  #define GRID_MAX_POINTS_Y GRID_MAX_POINTS_X
